...
describe('UpgradeableBridgeContract', () => {
    ...
    describe('3. After deployment', () => {
        ...
        beforeEach(async () => {
            ...
            const TutorialToken = await ethers.getContractFactory("TutorialToken", tokenWallet)
            tutorialToken = await upgrades.deployProxy(TutorialToken, [1000]) as TutorialToken
            await tutorialToken.deployed()
